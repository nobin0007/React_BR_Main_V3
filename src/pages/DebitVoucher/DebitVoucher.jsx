...
const emptyRows = [
    { accountHead: { Name: "", AccountsId: "" }, controlAccName: { Name: "", id: "" }, project: { Name: "", Code: "", ProjectId: "" }, particulars: "", debit: "", name: { Name: "", TableName: "", Id: "" } },
...
const emptyRowsFeatureOn = [
    { accountHead: { Name: "", AccountsId: "" }, controlAccName: { Name: "", id: "" }, project: { Name: "", Code: "", ProjectId: "" }, particulars: "", debit: "", name: [], nameClues: [] },
...
const NameComponentCredit = (props) => {
...
const DebitVoucher = (props) => {
    ...
    const [creditVoucherInfo, setCreditVoucherInfo] = useState({ accountHead: { Name: "", AccountsId: "" }, controlAccName: { Name: "", id: "" }, project: { Name: "", Code: "", ProjectId: "" }, particulars: "", credit: "", name: { Name: "", TableName: "", Id: "" } })
    ...
    const [accountsHeadCred, setAccountsHeadCred] = useState([]);
    const [accountsHead, setAccountsHead] = useState([]);
    const [project, setProject] = useState([]);

    const [allNames, setAllNames] = useState([]);
    const [total, setTotal] = useState({ debit: 0 });
    ...
    const [creditNameTrigger, setCreditNameTrigger] = useState(false);
    ...
    const btnNameModal = (currentRowIndex) => {
        ...
        if (currentRow?.nameClues) {
            axios.post(`${userInfo.Ip}/API/DebitVouch/GetAutoCompOptions`, currentRow.nameClues)
                .then(res => {
    ...
    const btnNameModalCreditTrigger = () => {
        setNameModalInputs({
            // rowIndex: "",
            inputs: []
        })

        setCreditNameTrigger(true);

        let currentRow = creditVoucherInfo;
        console.log("modal on korte bolsi credit Name theke!!");
        console.log(currentRow);
    ...
    useEffect(() => {
        ...
        if ((brFeatures?.VariableAccountAnalysis)) {
            setVoucherTableData(emptyRowsFeatureOn);
            setCreditVoucherInfo({ accountHead: { Name: "", AccountsId: "" }, controlAccName: { Name: "", id: "" }, project: { Name: "", Code: "", ProjectId: "" }, particulars: "", credit: "", name: [], nameClues: [] },)
    ...
    useEffect(() => {
        ...
        if (debitVouchToEdit?.VoucherId) { //maane jodi debitVouchToEdit e kono voucher edit er jonno thake, mot kotha kono value thakle
            ...
            if (brFeatures?.VariableAccountAnalysis) {
                fetch(`${userInfo.Ip}/API/DebitVouch/Get_VoucherAllInfoFeatOn?voucherNo=${debitVouchToEdit.VoucherNo}&voucherId=${debitVouchToEdit.VoucherId}`)
                    .then(res =>
                        res.json()
                        // console.log(res);
                    )
                ...
                fetch(`${userInfo.Ip}/API/DebitVouch/Get_VoucherAllInfo?voucherNo=${debitVouchToEdit.VoucherNo}&voucherId=${debitVouchToEdit.VoucherId}`)
                    .then(res =>
                        res.json()
                        // console.log(res);
                    )
    ...
    useEffect(() => {
        ...
        fetch(`${userInfo.Ip}/API/DebitVouch/Get_Project?companyId=${userInfo.CompanyId}`)
            .then(res =>
                res.json()
                // console.log(res);
            )
        ...
        fetch(`${userInfo.Ip}/API/DebitVouch/Get_AccountHeadCred?locationId=${userInfo.LocationId}&companyId=${userInfo.CompanyId}&identificationType=${radioVal}`)
            .then(res =>
                res.json()
                // console.log(res);
            )
            .then((data) => {
                ...
                // console.log(accHead);
                setAccountsHeadCred(accHead);
            })

        fetch(`${userInfo.Ip}/API/DebitVouch/Get_AccountHeadAll?companyId=${userInfo.CompanyId}&locationId=${userInfo.LocationId}`)
            .then(res =>
                res.json()
                // console.log(res);
            )
        ...
        fetch(`${userInfo.Ip}/API/DebitVouch/Get_AllBuyerEmpSupLoc?companyId=${userInfo.CompanyId}`)
            .then(res =>
                res.json()
                // console.log(res);
            )
    ...
    const handleAccountHeadSelect = (index, selectedOption) => {
        ...
        const url = `${userInfo.Ip}/API/DebitVouch/Get_ControlAccount?controlAccId=${selectedOption.ControlAccountId}`;
        fetch(url, {
            method: 'GET',
        })
            .then(res => res.json())
            .then(data => {
                ...
                if (voucherTableData.length - 1 == index) {
                    prevTableDataOld.push({ accountHead: { Name: "", AccountsId: "" }, controlAccName: { Name: "", id: "" }, project: { Name: "", Code: "", ProjectId: "" }, particulars: "", debit: "", name: { Name: "", TableName: "", Id: "" } });
                }
    ...
    const handleAccountHeadSelectFeatOn = (index, selectedOption) => {
        ...
        fetch(url, {
            ...
            .then(data => {
                ...
                // debugger;
                fetch(`${userInfo.Ip}/API/DebitVouch/GetRequiredInputInfos?accountId=${selectedOption.AccountsId}&companyId=${userInfo.CompanyId}&locationId=${userInfo.LocationId}`, {
                    method: 'GET',
                })
                    .then(res => res.json())
                    .then(data2 => {
                        ...
                        // --[checking if the accound head is getting selected in the last row, if does, insert another empty row below(auto adding row)]--
                        if (voucherTableData.length - 1 == index) {
                            prevTableDataOld.push({ accountHead: { Name: "", AccountsId: "" }, controlAccName: { Name: "", id: "" }, project: { Name: "", Code: "", ProjectId: "" }, particulars: "", debit: "", name: [], nameClues: [] });
                        }
    ...
    const handleCreditAccHeadSelection = (e, selectedOption) => {
        // setCreditVoucherInfo({ accountHead: { Name: "", AccountsId: "" }, controlAccName: { Name: "", id: "" }, project: { Name: "", Code: "", ProjectId: "" }, particulars: "", debit: "", name: [], nameClues: [] });

        if (!selectedOption) {
            creditVoucherInfo.project = {};
            creditVoucherInfo.accountHead = {};
            creditVoucherInfo.controlAccName = {};

            setCreditVoucherInfo({ ...creditVoucherInfo });
            ...
            creditVoucherInfo.name = [];
            creditVoucherInfo.nameClues = [];

            setCreditVoucherInfo({ ...creditVoucherInfo });

            console.log(selectedOption);
            creditVoucherInfo.accountHead = selectedOption;
            console.log("from head selection......")
            // --[filling project cell of the same row]--
            const matchedIndex = project.findIndex(e => e.Code === 'GN');
            console.log(matchedIndex);
            console.log(project[matchedIndex]);
            if (matchedIndex > -1 && !(creditVoucherInfo.project?.ProjectId)) {
                creditVoucherInfo.project = project[matchedIndex];
            }
            // setCreditVoucherInfo({ ...creditVoucherInfo });
            ...
            if (brFeatures.VariableAccountAnalysis) {
                fetch(`${userInfo.Ip}/API/DebitVouch/GetRequiredInputInfos?accountId=${selectedOption?.AccountsId}&companyId=${userInfo.CompanyId}&locationId=${userInfo.LocationId}`, {
                    ...
                    .then(data2 => {
                        ...
                        if (data2.length) {
                            console.log("data2 er length 0 theke greater");
                            console.log("creditVoucherInfo: ");

                            creditVoucherInfo.nameClues = [...data2];
                            console.log(creditVoucherInfo.nameClues)
                        }
                        else {
                            ...
                            creditVoucherInfo.nameClues = [...generalFourNameClues];
                        }
    ...
    const saveVTdata = () => {
        ...
        if (!creditVoucherInfo.accountHead?.AccountsId) {
            mandatoryFieldFlag = false;
            toast.error(`You must select a Credit Account Head!`);
        }
        else if (!creditVoucherInfo.project?.ProjectId) {
            mandatoryFieldFlag = false;
        ...
        for (let i = 0; i < tableAllRows.length; i++) {
            ...
            if (!rowIsEmpty) {
                ...
                if ((tableAllRows[i].accountHead.AccountsId) && !(tableAllRows[i].debit)) {
                    mandatoryFieldFlag = false;
                    toast.error(`You must entry a debit for row: ${i + 1}`);
                }
        ...
        let creditRowObj = {
            AccountsId: (creditVoucherInfo.accountHead?.AccountsId) ? creditVoucherInfo.accountHead?.AccountsId : "",
            ProjectId: (creditVoucherInfo.project?.ProjectId) ? creditVoucherInfo.project?.ProjectId : "",
            Particulars: creditVoucherInfo.particulars ? creditVoucherInfo.particulars : "",
            Debit: 0,
            Credit: total.debit,
        }
        if (creditVoucherInfo?.name?.Id) {
            let propertyNameCred = `${creditVoucherInfo?.name?.TableName}Id`;
            creditRowObj[propertyNameCred] = creditVoucherInfo.name?.Id;
        }
        voucherDtTb.push(creditRowObj);
        ...
        if (voucherDtTb.length && voucherDtTbB4Cred.length && debitCreditFlag && mandatoryFieldFlag) {
            ...
            axios.post(`${userInfo.Ip}/API/DebitVouch/Post_DV_Voucher`, voucherFullData)
                .then(res => {
                    ...
                    if (res) {
                        ...
                        fetch(`${userInfo.Ip}/API/DebitVouch/Get_VoucherAllInfo?voucherNo=${res.data.VoucherNo}&voucherId=${res.data.VoucherId}`)
                            .then(res =>
                                res.json()
                                // console.log(res);
                            )
                            .then((data) => {
                                ...
                                setDebitVouchToEdit(0); //context api voucherEdit state reset
    ...
    const saveVTdataFeatOn = () => {
        ...
        if (creditVoucherInfo.name?.length) {
            for (let j = 0; j < creditVoucherInfo.name.length; j++) {
                creditRowObj[creditVoucherInfo.name[j].PropertyName] = creditVoucherInfo.name[j].Id;
            }
        }
            ...
            axios.post(`${userInfo.Ip}/API/DebitVouch/Post_DV_Voucher`, voucherFullData)
                .then(res => {
                    ...
                    if (res) {
                        ...
                        fetch(`${userInfo.Ip}/API/DebitVouch/Get_VoucherAllInfoFeatOn?voucherNo=${res.data.VoucherNo}&voucherId=${res.data.VoucherId}`)
                            .then(res =>
                                res.json()
                                // console.log(res);
                            )
    ...
    const clearData = () => {
        ...
        setCreditVoucherInfo({ accountHead: { Name: "", AccountsId: "" }, controlAccName: { Name: "", id: "" }, project: { Name: "", Code: "", ProjectId: "" }, particulars: "", credit: "", name: { Name: "", TableName: "", Id: "" } })
    ...
    const assignDataForEdit = (voucherDate, voucherLocationId, voucherLocationName, voucherId, voucherNo, voucherAttachmentId, reference, description, vouchDtTable, attachmentTable) => {
        ...
        for (let i = 0; i < vouchDtTable.length; i++) {
            ...
            if (vouchDtTable[i].Credit == 0 && vouchDtTable[i].Debit > 0) {
                ...
                creditRow = objRow;
                creditRowFormatted = perRowFormatted;
            }
        ...
        setCreditVoucherInfo(creditRow);
        ...
        setExVoucherTableData({ Voucher: voucherTb, VoucherDetail: voucherTableArrNoEmpty, CreditDetail: creditRowFormatted })
        setdebitCreditWatch((prev) => !prev);
    }
    ...
    const updateVTData = () => {
        ...
        let creditInfoFormatted = {
            VoucherDetailId: (creditVoucherInfo.voucherDetailId) ? creditVoucherInfo.voucherDetailId : "",
            AccountsId: (creditVoucherInfo.accountHead?.AccountsId) ? creditVoucherInfo.accountHead?.AccountsId : "",
            ProjectId: (creditVoucherInfo.project?.ProjectId) ? creditVoucherInfo.project?.ProjectId : "",
            Particulars: creditVoucherInfo.particulars,
            Debit: 0,
            Credit: total.debit
        }
        if (creditVoucherInfo.name?.Id) {
            creditInfoFormatted[`${creditVoucherInfo.name.TableName}Id`] = creditVoucherInfo.name?.Id;
        }

        if (!creditInfoFormatted.AccountsId) {
            toast.error("You must enter a Credit Account Head");
            mandatoryFieldFlag = false;
        }
        else if (!creditInfoFormatted.ProjectId) {
            toast.error("You must enter a Credit Project");
            mandatoryFieldFlag = false;

        }
        else if (JSON.stringify(creditInfoFormatted) != JSON.stringify(exVoucherTableData.CreditDetail) && creditInfoFormatted.AccountsId && creditInfoFormatted.ProjectId) {
            console.log("hello rupom yo yo");
            console.log(creditInfoFormatted);
            console.log(exVoucherTableData.CreditDetail);
            creditRowToUpdate = creditInfoFormatted;
            vouchDtToUpdate = [...vouchDtToUpdate, creditRowToUpdate];
        }
        ...
        if (voucherDtTb.length && debitCreditFlag && mandatoryFieldFlag && flagSomethingToUpdate) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    // setVoucherNumber(res.data);
                    // vouchNoInpRef.current.value = res.data;
                    axios.post(`${userInfo.Ip}/API/DebitVouch/Update_DV_Voucher`, voucherFullData)
                        .then(res => {
                            console.log("insert er axios!!")
                            if (res) {
                                ...
                                fetch(`${userInfo.Ip}/API/DebitVouch/Get_VoucherAllInfo?voucherNo=${res.data.Voucher.VoucherNo}&voucherId=${res.data.Voucher.VoucherId}`)
                                    .then(res =>
                                        res.json()
                                        // console.log(res);
                                    )
    ...
    const updateVTDataFeatOn = () => {
        ...
        if (creditVoucherInfo.name?.length) {
            for (let j = 0; j < creditVoucherInfo.name.length; j++) {
                creditInfoFormatted[creditVoucherInfo.name[j].PropertyName] = creditVoucherInfo.name[j].Id;
            }
        }

        console.log("creditVoucherInfo Name from Update:");
        console.log(creditVoucherInfo);
                    ...
                    axios.post(`${userInfo.Ip}/API/DebitVouch/Update_DV_Voucher`, voucherFullData)
                        .then(res => {
                            ...
                            if (res) {
                                ...
                                fetch(`${userInfo.Ip}/API/DebitVouch/Get_VoucherAllInfoFeatOn?voucherNo=${res.data.Voucher.VoucherNo}&voucherId=${res.data.Voucher.VoucherId}`)
                                    .then(res =>
                                        res.json()
                                        // console.log(res);
                                    )
    ...
    const cashBankRadio = (value) => {
        ...
        Swal.fire({
            title: `Are you sure?`,
            text: 'Options for credit account head will get changed!',
            showDenyButton: true,
            icon: 'question',
            showCancelButton: false,
            confirmButtonText: 'Yes,I am!',
            ...
            if (result.isConfirmed) {
                ...
                fetch(`${userInfo.Ip}/API/DebitVouch/Get_AccountHeadCred?locationId=${userInfo.LocationId}&companyId=${userInfo.CompanyId}&identificationType=${value}`)
                    .then(res =>
                        res.json()
                        // console.log(res);
                    )
    ...
    const rupom = () => {
        ...
        fetch(`${userInfo.Ip}/API/DebitVouch/Get_AccountHeadCred?locationId=${1}&companyId=${1}&identificationType=${"Cash"}`)
            .then(res =>
                res.json()
                // console.log(res);
            )
                    ...
                    <div className="block rounded-lg shadow-lg bg-white dark:bg-secondary-dark-bg  text-center">
                        ...
                        <div className=" px-6 pb-4 text-start md:min-h-[60vh] grid grid-cols-4 gap-4 mt-2">
                            ...
                            <fieldset className="md:col-span-4 col-span-4 border border-solid border-gray-300 px-3 pt-1 pb-3 dark:text-slate-50">
                                <legend className="text-sm">Debit Voucher</legend>
                                    ...
                                    <div className='w-full grid-cols-2 grid gap-x-4 gap-y-1'>
                                        ...
                                        <div className='col-span-2 grid-cols-4 grid gap-x-4 gap-y-1'>
                                            <Autocomplete
                                                ...
                                                clearOnEscape
                                                size="small"
                                                options={accountsHeadCred}
                                                getOptionLabel={(option) => (option.Name) ? option.Name : ""}
                                                value={creditVoucherInfo.accountHead ? creditVoucherInfo.accountHead : ""}
                                                onChange={(e, selectedOption) => {
                                                    // console.log(selectedOption);
                                                    // creditVoucherInfo.accountHead = selectedOption;
                                                    // console.log("from head selection......")
                                                    ...
                                                    handleCreditAccHeadSelection(e, selectedOption);
                                                ...
                                                renderInput={(params) => (
                                                    <TextField
                                                        ...
                                                        label="Credit Account Head" variant="standard" />
                                                )}
                                            />
                                            <Autocomplete
                                                id="credProject"
                                                ...
                                                options={project}
                                                getOptionLabel={(option) => (option.Name) ? option.Name : ""}
                                                value={(creditVoucherInfo.project) ? creditVoucherInfo.project : { Name: '', Code: '', ProjectId: '' }}

                                                onChange={(e, selectedOption) => {
                                                    console.log(selectedOption);
                                                    creditVoucherInfo.project = selectedOption;
                                                    setCreditVoucherInfo({ ...creditVoucherInfo });
                                                }}
                                                renderInput={(params) => (
                                                    <TextField
                                                        ...
                                                        inputRef={(node) => {
                                                            if (node) {
                                                                node.value = (creditVoucherInfo.project?.Name) ? creditVoucherInfo.project?.Name : "";
                                                            }
                                                        }}
                                            ...
                                            {brFeatures.VariableAccountAnalysis ?
                                                (
                                                    <NameComponentCredit nameArr={creditVoucherInfo.name} btnNameModalFunct={btnNameModalCreditTrigger} />
                                                ) :
                                                (
                                                    ...
                                                    <Autocomplete
                                                        ...
                                                        size="small"
                                                        options={allNames}
                                                        value={(creditVoucherInfo.name) ? creditVoucherInfo.name : { Name: '', Id: '', TableName: '' }}

                                                        onChange={(e, selectedOption) => {
                                                            console.log(selectedOption);
                                                            creditVoucherInfo.name = selectedOption;
                                                            setCreditVoucherInfo({ ...creditVoucherInfo });
                                                            // setLocationOutput(selectedOption);
                                                        }}
                                                        getOptionLabel={(option) => (option.Name) ? option.Name : ""}
                                                        ...
                                                        renderInput={(params) =>
                                                            ...
                                                            <TextField
                                                                ...
                                                                {...params}
                                                                // {...register("credName")}
                                                                // value={(creditVoucherInfo.name?.Name) ? creditVoucherInfo.name?.Name : ""}
                                                                // inputRef={(node) => {
                                                                //     if (node) {
                                                                //         node.value = creditVoucherInfo.name?.Name;
                                                                //     }
                                                                // }}
                                            ...
                                            <Controller
                                                name="credParticulars"
                                                control={control}
                                                render={({ field }) => (
                                                    <TextField
                                                        {...field}
                                                        sx={{ width: '100%' }} InputProps={{ style: { fontSize: 13 } }}
                                                        // value={creditVoucherInfo.particulars ? creditVoucherInfo.particulars : ""}
                                                        inputRef={node => {
                                                            if (node) {
                                                                node.value = creditVoucherInfo.particulars ? creditVoucherInfo.particulars : ""
                                                        ...
                                                        onBlur={(e) => {
                                                            ...
                                                            creditVoucherInfo.particulars = e.target.value;
                                                            setCreditVoucherInfo({ ...creditVoucherInfo });
                                                        }}
                                                        InputLabelProps={{
                                                            style: { fontSize: 14 },
                                                            shrink: field.value || creditVoucherInfo.particulars
                                                            // shrink: (field.value ? true : false)

                                                        }}

                                                        id="credParticulars" label="Credit Particulars" variant="standard" size="small"
                                                    //  multiline
                                                    // maxRows={4} 
                                                    />
                                                )}
                ...
                <Box sx={{ ...nameModalStyle }}>
                    <fieldset className="border border-solid border-gray-300 px-3 pt-1 pb-3 dark:text-slate-50">
                        ...
                        {nameModalInputs.inputs.map(perInp => {
                            ...
                            if (creditNameTrigger) {
                                currentVouchTbDataRow = creditVoucherInfo;
                            }
                            else {
