...
const VoucherPosting = (props) => {
    ...
    useEffect(() => {
        //Fetch locations 
        fetch(`${userInfo.Ip}/API/VoucherPosting/Get_Location?companyId=${userInfo.CompanyId}`)
            .then(res =>
                res.json()
                // console.log(res);
            )
        ...
        fetch(`${userInfo.Ip}/API/VoucherPosting/Get_VoucherTypes`)
            .then(res =>
                res.json()
                // console.log(res);
            )
        ...
        // fetch(`${userInfo.Ip}/API/VoucherPosting/Get_VouchersForPosting?dateFrom=${dateFrom}&dateTo=${dateTo}&voucherType=${voucherTypeOutput.Name}&locationId=${locationOutput.LocationId}&companyId=${userInfo.CompanyId}`)
        //     .then(res =>
        //         res.json()
        //         // console.log(res);
        //     )
    ...
    const fetchDataForVoucherTable = () => {
        if (dateTo && dateFrom) {
            if (dateFrom.diff(dateTo) <= 0) {
                ...
                fetch(`${userInfo.Ip}/API/VoucherPosting/Get_VouchersForPosting?dateFrom=${dfrom}&dateTo=${dto}&voucherType=${voucherTypeOutput.Value}&locationId=${locationOutput.LocationId}&companyId=${userInfo.CompanyId}`)
                    .then(res =>
                        res.json()
                        // console.log(res);
                    )
    ...
    const postVoucherFunc = () => {
        console.log('posting voucher, readin mrt selected state');
        ...
        axios.post(`${userInfo.Ip}/API/VoucherPosting/Post_Voucher`, voucherFullData)
            .then(res => {
                ...
                if (res) {
                    ...
                    if (res.status == 200) {
                        ...
                        Swal.fire({
                            title: `Your selected vouchers have been posted successfully!`,
                                            ...
                                            onChange={(e, selectedOption) => {
                                                ...
                                                if (dateTo && dateFrom) {
                                                    if (dateFrom.diff(dateTo) <= 0) {
                                                        ...
                                                        fetch(`${userInfo.Ip}/API/VoucherPosting/Get_VouchersForPosting?dateFrom=${dfrom}&dateTo=${dto}&voucherType=${selectedOption.Value}&locationId=${locationOutput.LocationId}&companyId=${userInfo.CompanyId}`)
                                                            .then(res =>
                                                                res.json()
                                                            )
                                                            .then((data) => {
                                            ...
                                            onChange={(e, selectedOption) => {
                                                ...
                                                if (dateTo && dateFrom) {
                                                    if (dateFrom.diff(dateTo) <= 0) {
                                                        ...
                                                        fetch(`${userInfo.Ip}/API/VoucherPosting/Get_VouchersForPosting?dateFrom=${dfrom}&dateTo=${dto}&voucherType=${voucherTypeOutput.Value}&locationId=${selectedOption.LocationId}&companyId=${userInfo.CompanyId}`)
                                                            .then(res =>
                                                                res.json()
                                                            )
                                                            .then((data) => {
