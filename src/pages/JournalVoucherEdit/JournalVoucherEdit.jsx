...
const JournalVoucherEdit = (props) => {
    // ---[show/hide panel,navbar]---
    const navigate = useNavigate();

    const { setVoucherToEdit, voucherToEdit } = useStateContext();
    setVoucherToEdit(0);
    ...
    const redirectToEditVoucher = () => {
        console.log("rupom");
        setVoucherToEdit(voucherNumber);
        navigate('/journalVoucherIfrm');
    }
