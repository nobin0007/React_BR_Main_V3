...
const AttachmentLoader = (props) => {
    ...
    const downloadFile = (e) => {
        ...
        var win = window.open();
        win.document.write('<iframe src="' + e.target.getAttribute('data-fileb64') + '" frameborder="0" style="border:0; top:0px; left:0px; bottom:0px; right:0px; width:100%; height:100%;" allowfullscreen></iframe>');
    ...
    const deleteFile = (index) => {
        ...
        console.log(index);
        if (allAttachments[index].autoSL) {
            setDeletedRegedAttach([...deletedRegedAttach, { AutoSL: allAttachments[index].autoSL, FileName: allAttachments[index].fileName }]);
        }
            ...
            <div className='relative -mb-[11px] -ml-[11px] z-[1]'>
                ...
                {attachments.length ? (
                    <Tooltip title="Attach File" arrow>
                        <label htmlFor="fileAttachInput" id="attachmentLabel" className='inline-block px-[6px] py-1 bg-slate-500 text-white font-medium text-xs leading-tight rounded-full shadow-md cursor-pointer hover:bg-blue-700 hover:shadow-lg hover:scale-110 focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-900  active:-translate-y-1 active:shadow-lg transform-all duration-150 ease-in-out'><i className="fas fa-plus"></i>
                        </label>
                    </Tooltip>) : (
                    <label htmlFor="fileAttachInput" id="attachmentLabel" className='inline-block px-[6px] py-1 bg-slate-500 text-white font-medium text-xs leading-tight rounded-full cursor-pointer hover:bg-blue-700 hover:shadow-lg hover:scale-110 focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-900  active:-translate-y-1 active:shadow-lg transform-all duration-150 ease-in-out '><i className="fas fa-plus"></i> Attach Files
                    </label>
                )}
